...
[![Chrome Web Store](https://img.shields.io/chrome-web-store/v/cdfjoacadlmfmgnfkfnpofokhapihbol?style=for-the-badge&logo=googlechrome&logoColor=white&label=Chrome%20Web%20Store&color=4285F4)](https://chromewebstore.google.com/detail/doxdock-private-pdf-image/cdfjoacadlmfmgnfkfnpofokhapihbol)
...
- **[Add DoxDock to Chrome](https://chromewebstore.google.com/detail/doxdock-private-pdf-image/cdfjoacadlmfmgnfkfnpofokhapihbol)** to run every tool from your browser, fully on your device, even offline.
- **[Open the web app](https://doxdock.vercel.app)** if you would rather not install anything. It works in any modern browser and can be added as a PWA.

Both are the same app, and both keep every file on your machine.
